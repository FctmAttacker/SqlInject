...
"""
Copyright (c) 2006-2019 SDARKYELLOW (http://sqlmap.org/)
...
try:
    ...
    try:
        ...
        sys.exit("[!] wrong installation detected (missing modules). Visit 'https://github.com/FctmAttacker/SqlInjection#installation' for further details")
